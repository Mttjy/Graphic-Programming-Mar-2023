...
function setup() {
    ...
    thresholdSlider = createSlider(0, 255, 60);
    thresholdSlider.position(20, 20);
    
    grid = new Grid(680, 480);
}
...
function draw() {
    ...
    befImg = createImage(currImg.width, currImg.height);
    befImg.copy(currImg, 0, 0, currImg.width, currImg.height, 0, 0, currImg.width, currImg.height);
